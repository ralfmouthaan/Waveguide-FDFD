...
Ex_New{3} = RetVal.Ex{7};
Ey_New{3} = RetVal.Ey{7};
Eabs_New{3} = RetVal.Eabs{7};
beta_New(3) = RetVal.beta(7);

Ex_New{4} = RetVal.Ex{11};
Ey_New{4} = RetVal.Ey{11};
Eabs_New{4} = RetVal.Eabs{11};
beta_New(4) = RetVal.beta(11);

Ex_New{5} = RetVal.Ex{13};
Ey_New{5} = RetVal.Ey{13};
Eabs_New{5} = RetVal.Eabs{13};
beta_New(5) = RetVal.beta(13);

Ex_New{6} = RetVal.Ex{14};
Ey_New{6} = RetVal.Ey{14};
Eabs_New{6} = RetVal.Eabs{14};
beta_New(6) = RetVal.beta(14);

Ex_New{7} = RetVal.Ex{13} + RetVal.Ex{14};
Ey_New{7} = RetVal.Ey{13} + RetVal.Ey{14};
Eabs_New{7} = sqrt(abs(Ex_New{7}).^2 + abs(Ey_New{7}).^2);
beta_New(7) = (RetVal.beta(13) + RetVal.beta(14));

Ex_New{8} = RetVal.Ex{13} + exp(1i*pi)*RetVal.Ex{14};
Ey_New{8} = RetVal.Ey{13} + exp(1i*pi)*RetVal.Ey{14};
Eabs_New{8} = sqrt(abs(Ex_New{8}).^2 + abs(Ey_New{8}).^2);
beta_New(8) = (RetVal.beta(13) + RetVal.beta(14));
...
save('Lin Polarised Modes.mat', 'RetVal_New', '-v7.3');
